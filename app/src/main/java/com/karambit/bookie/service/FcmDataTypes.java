...
public class FcmDataTypes {
    public static final int FCM_DATA_TYPE_SENT_MESSAGE = 0;
    public static final int FCM_DATA_TYPE_DELIVERED_MESSAGE = 1;
    public static final int FCM_DATA_TYPE_SEEN_MESSAGE = 2;
    public static final int FCM_DATA_TYPE_REQUEST_SENT = 3;
